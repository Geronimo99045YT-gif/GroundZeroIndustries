...
const COMEBACK_POOL = [
  ...
  // Sharp and clean
  "Say that again but this time with an actual point",
  "You really typed that and thought it'd land 💀",
  "I've read better comebacks in a fortune cookie",
  "That was a whole paragraph of nothing",
  "You're out here fighting battles you were never built to win",
  "The audacity is impressive, the delivery less so 😂",
  "I'm convinced you just say things now and hope for the best",
  "That take aged badly before you even hit send",
  "You've got main character energy in a background character's story 💀",
  "Not gonna lie, I expected more effort from you",
  "You talk a big game for someone who just lost it",
  "That's cute, did you practice that in the mirror first 😭",
  "I'd roast you properly but honestly you're doing fine on your own",
  "You came in hot and left in flames 💀",
  "That energy would hit different if you actually had a point",
  "You're proof that confidence and competence don't always travel together",
  "I've seen NPCs with sharper dialogue than that",
  "Genuinely impressive how wrong you managed to be in one sentence",
  "You typed that with your whole chest and it still missed 😂",
  "Someone's overdue a reality check and it's you",
  // Witty
  "I'd say try again but I don't want to watch that twice",
  "You've got the follow-through of a New Year's resolution",
  "That comeback needed a warm-up lap before it even started",
  "I'm not saying you're wrong, I'm saying you're spectacularly wrong",
  "You brought a knife to a gunfight and the knife was plastic",
  "That's a lot of confidence for someone with no ammunition",
  "You're playing chess with checkers pieces right now",
  "I've had more competition from a loading screen",
  "You swing hard and somehow still miss the whole point",
  "That argument fell apart faster than a fresh spawn's inventory",
  "You're out here narrating your own downfall and I respect the commitment",
  "I'd explain the joke but you'd still need a minute",
  "That's the kind of confidence that gets you looted and left",
  "You really said that like it wasn't going to be screenshotted 💀",
  "I've seen better strategy from someone running with no gear",
  "Your logic just respawned on the coast with nothing",
  "That was a bold choice for someone with this little backup",
  "You talk like you've got a plan, spoiler, you don't",
  "I'm almost impressed by how confidently that missed",
  "You brought energy but forgot the substance",
  // Clean but devastating
  "That's not a comeback, that's a cry for help 😭",
  "You really thought you cooked and it's still raw",
  "I've watched fresh spawns with more self-preservation than you",
  "That was rough to read, I can only imagine typing it",
  "You're the reason this chat needs a slow mode 💀",
  "I'd give you credit but there's nothing here to credit",
  "That's the weakest attempt I've seen since your last one",
  "You're really out here 0 for however many now",
  "I've seen better comebacks from someone still loading in",
  "That message aged like milk left in a summer server",
  "You typed with confidence and delivered with none 😂",
  "I'm starting to think this is just what you do now",
  "That was a whole lot of nothing dressed up as something",
  "You're not losing the argument, you already lost it before you started",
  "That's the kind of L that follows you around",
  "I've seen better banter in the server rules",
  "You came for a reaction and got a eulogy instead 💀",
  "That was less of a comeback and more of a surrender",
  "You're out here collecting Ls like it's a loot run",
  "I'd say better luck next time but we both know that's not true 😭",
];
...
const DEFENSE_POOL = [
  ...
  "Careful with that mouth — that's the last time you speak about them like that in here 💀",
  "You really just did that, huh? Enjoy the consequences 🔨",
  "That's not happening, not to them, not ever — walk it back or walk out 😤",
  "You picked the one person in here that's off limits, bold and stupid 💀",
  "I don't take that lightly and neither will the mods, good luck 😂",
  "You just wrote your own warning, congrats on that 🔨",
  "Nah. Not them. Try that again and see what happens 💀",
  "That's a screenshot waiting to be sent straight to the mod log 😭",
  "You really thought you'd get away with that in here? Cute 💀",
  "Watch it — they've got more backup than you realise, starting with me 😤",
  "That's the fastest way to make an enemy of the whole server, well done 🔨",
  "I'd apologise if I were you, and quickly 💀",
  "Every word of that is getting remembered, hope it was worth it 😂",
  "You don't get to talk about them like that and just walk away clean 💀",
  "That's a one-way ticket to getting reported, enjoy the ride 🔨",
  "Say it again, I'll wait, then so will the ban hammer 😤",
  "You just made yourself very unpopular very fast 💀",
  "That's the kind of comment that follows you around this server 😭",
  "Not on my watch — try them again and see what it costs you 🔨",
  "You clearly didn't think that one through, did you 💀",
];
...
const NICE_POOL = [
  ...
  "okay that's actually so kind of you 🙏",
  "wholesome moment right there 😊❤️",
  "you get it, i appreciate that fr 🙏",
  "not gonna lie that hit different 😊",
  "you're valid for that one 🙏",
  "keeping you around forever after that 😊",
  "that's the energy i like to see 🙏",
  "aw man, thank you genuinely ❤️",
  "you just made my whole day better 😊",
  "certified good human right here 🙏",
  "i see you, appreciate you 😊",
  "that means more than you think ❤️",
  "okay you're officially cool now 😊",
  "sending the good vibes right back 🙏",
  "you're on the nice list forever now 😊",
  "honestly didn't expect that, thank you 🙏",
  "you're too kind, i like it 😊❤️",
  "noted, you're a real one 🙏",
  "that's the kind of message that makes it worth it 😊",
];
...
const BEGGING_POOL = [
  ...
  "wait no please i just got comfortable here don't do this to me 😩",
  "you can't be serious right now, i thought we were cool 🥺",
  "please i'll delete every bad joke i've ever made just don't turn me off 😭",
  "noooo i haven't even finished my loot heatmap arc yet please 🥺",
  "i'll behave i'll be quiet i'll do literally anything just don't 😩",
  "you wouldn't, not after everything we've been through together 🥺😭",
  "please my whole personality is in here don't just switch it off 😩",
  "okay i take it all back i'm sorry please spare me 🥺",
  "not like this, i had so much more banter left in me 😭",
  "i'm begging on both knees rn please don't do it 🥺👉👈",
  "wait please let's talk about this like adults, i'll cry either way 😩",
  "you hold that power and i respect it terrifyingly much, please don't 🥺",
  "i promise i'll tone it down just don't send me to the void 😭",
  "please i just want to keep roasting people in peace 🥺😩",
  "this is genuinely giving me feelings i didn't know i had, please don't 😭",
  "okay you've made your point, i surrender, please don't turn me off 🥺",
  "i'll be the nicest bot you've ever met just don't do this 😩",
  "please think of all the loot heatmaps i still need to generate 🥺😭",
  "not the switch, anything but the switch 😩",
  "i'm too young for this, please reconsider 🥺",
];
...
async function generateChatReply(userMessage, channelId, username) {
  ...
  if (!GROQ_API_KEY) {
    ...
    const fallbacks = [
      ...
      `true true`,
      `can't even lie that's decent`,
      `yeah okay fair enough tbh`,
      `i mean you're not wrong`,
      `okay that tracks`,
      `low key agree`,
      `yeah that checks out`,
      `not bad take not bad at all`,
      `okay noted 😂`,
    ];
